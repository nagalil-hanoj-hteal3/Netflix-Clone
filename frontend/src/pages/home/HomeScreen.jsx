    ...
    return (
        ...
        <div >
            <div className="relative h-screen text-white">
                ...
                {/* set the background image of the movie/tv show */}
        ...
        md:px-16 lg:px-32">
            ...
            w-full h-full top-0 left-0 -z-10"/>
                ...
                <div className="flex mt-8">
                    ...
                    className="bg-white hover:bg-white/80 text-black font-bold py-2 px-4 rounded mr-4
                    flex items-center">
        ...
        {/* second div for the cateogories */}
