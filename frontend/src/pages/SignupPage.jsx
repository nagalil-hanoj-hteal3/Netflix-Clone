            ...
            <div className="w-full max-w-md p-8 space-y-6 bg-black/65 rounded-lg shadow-md">
                ...
                <form className="space-y-4" onSubmit={handleSignUp}>
                    ...
                    <div>
                        ...
                        <input type="text"
                        className="w-full px-3 py-2 mt-1 border border-gray-700 rounded-md bg-transparent text-white
                        focus:outline-none focus:ring" placeholder="john.doe" id="username"
                    ...
                    <div>
                        ...
                        <p className={`text-sm mt-1 ${passwordStrength === "Strong" ? "text-green-400" : passwordStrength === "Intermediate" ? "text-yellow-400" : "text-red-400"}`}>
                    ...
                    <div className="text-center text-gray-400">
                        Already a member?{" "}
                        <Link to={"/login"} className="text-red-600 hover:underline">Sign in
                        </Link>
                    </div>
